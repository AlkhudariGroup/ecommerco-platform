      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-left gap-8">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Manage clients, billing, and platform-wide analytics.
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Configure your AI agent, connect WooCommerce, and view logs.
          </p>
        </Link>
        <Link
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Monitor live conversations, handle escalations, and quick actions.
          </p>
        </Link>
      </div>
    </main>
