        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white rounded-lg shadow border p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="#" className="px-3 py-2 bg-slate-900 text-white rounded">
                Add Client
              </Link>
            </div>
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-lg shadow border p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <Link href="#" className="inline-block mt-2 px-3 py-2 bg-slate-900 text-white rounded">
                Open Billing
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow border p-6">
            ...
            <div className="h-32 bg-gray-100 rounded grid place-items-center text-gray-500 text-sm">
              Chart
            </div>
          </div>
        </div>
